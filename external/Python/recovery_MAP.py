...
# Alpha Plot
plt.subplot(1, 2, 1)
sns.regplot(data=recovery_df, x='true_alpha', y='rec_alpha', scatter_kws={'alpha':0.3}, color='#264653')
plt.plot([0, 1], [0, 1], 'r--', label='Identity Line')
plt.title(f'Alpha Recovery (r={alpha_r:.2f})')
plt.xlabel('True Alpha')
plt.ylabel('Recovered Alpha')
...
plt.title(f'Beta Recovery (r={tau_r:.2f})')
plt.xlabel('True Beta')
plt.ylabel('Recovered Beta')
plt.legend()
plt.tight_layout()
plt.savefig('../../results/figures/parameter_recovery_MAP_60.png')
plt.show()
